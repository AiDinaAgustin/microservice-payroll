  ...
  const processPermissions = (data) => {
    data.forEach(permission => {
      ...
      if (permission.submenus) {
        processPermissions(permission.submenus);
      }
    });
  };
...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('sys_role_permissions', rolePermissionDummyData, {});
  },
